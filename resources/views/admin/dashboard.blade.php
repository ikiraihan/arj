            ...
            <div class="row row-gap-3 mb-4">
                ...
                <div class="col-xl-3 col-sm-6 d-flex">
                    <div class="card flex-fill mb-0 position-relative overflow-hidden">
                        ...
                        <img src="{{URL::asset('build/img/icons/elemnt-01.svg')}}" alt="elemnt-04" class="img-fluid position-absolute top-0 Start-0">
                    </div>
                </div>
                <!-- /Total Companies -->
                ...
                <div class="col-xl-3 col-sm-6 d-flex">
                    <div class="card flex-fill mb-0 position-relative overflow-hidden">
                        ...
                        <img src="{{URL::asset('build/img/icons/elemnt-02.svg')}}" alt="elemnt-04" class="img-fluid position-absolute top-0 Start-0">
                    </div>
                </div>
                <!-- /Total Companies -->
                ...
                <div class="col-xl-3 col-sm-6 d-flex">
                    <div class="card flex-fill mb-0 position-relative overflow-hidden">
                        ...
                        <img src="{{URL::asset('build/img/icons/elemnt-03.svg')}}" alt="elemnt-04" class="img-fluid position-absolute top-0 Start-0">
                    </div>
                </div>
                <!-- /Total Companies -->
                ...
                <div class="col-xl-3 col-sm-6 d-flex">
                    <div class="card flex-fill mb-0 position-relative overflow-hidden">
                        ...
                        <img src="{{URL::asset('build/img/icons/elemnt-04.svg')}}" alt="elemnt-04" class="img-fluid position-absolute top-0 Start-0">
                    </div>
                </div>
                <!-- /Total Companies -->
                ...
                <div class="col-xxl-4 col-xl-12 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <a href="{{url('purchase-transaction')}}" class="btn btn-primary btn-xs">View All</a>
                        </div>
                        <div class="card-body pb-2">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-01.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-02.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-03.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-04.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-0">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-05.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-07.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-08.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-09.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                <div class="d-flex align-items-center">                                         
                                    <a href="javscript:void(0);" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                        <img src="{{URL::asset('build/img/icons/company-icon-10.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                                ...
                                <div class="text-sm-end mb-0">
                                    <h6 class="fw-medium text-truncate mb-1 fs-14"><a href="" class="text-decoration-underline text-info">Send Reminder</a></h6>
                                    <p class="fs-13 mb-0">Basic (Monthly)</p>
                                </div>
                            </div>
