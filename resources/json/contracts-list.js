    ...
    if($('#contracts-list').length > 0) {
		$('#contracts-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fw-medium fs-14"><a href="company-details" class="avatar border rounded-circle me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details">'+row['customer']+'</a></h6>';
				}},                  
				{ "data": "contract_type" },                 
				{ "data": "date" },                 
				{ "data": "end_date" },				
