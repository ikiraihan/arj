    ...
    if($('#leads_reports').length > 0) {
		$('#leads_reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex fs-14 align-items-center fw-medium mb-0"><a href="company-details" class="avatar rounded-circle border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column">'+row['company_name']+'<span class="text-body fs-13 fw-normal mt-1">'+row['company_address']+' </span></a></h6>';
				}},
				{ "data": "phone" },
				{
					"render": function (data, type, row) {
