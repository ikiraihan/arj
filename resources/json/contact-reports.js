    ...
    if($('#contact_reports').length > 0) {
		$('#contact_reports').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="contact-details" class="avatar me-2"><img class="img-fluid rounded-circle" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact-details" class="d-flex flex-column">' + row['customer_name'] + ' <span class="text-body fs-13 fw-normal mt-1">' + row['customer_no'] + ' </span></a></h6>';
					}
				},
				{ "data": "phone" },
				{
				...
				{ 
					"render": function (data, type, row) {
						return '<div class="d-flex align-items-center mb-0"><a href="contact-details" class="avatar avatar-xss me-2"><img class="img-fluid rounded-circle" src="' + row['location_image'] + '" alt="User Image"></a>' + row['location_name'] + '</div>';
					}
				},
				{
					"render": function (data, type, row) {
