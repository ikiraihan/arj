    ...
    if($('#recent-project').length > 0) {
		...
		"columns": [
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="project-details" class="avatar avatar-rounded border me-2"><img class="w-auto h-auto" src="'+row['priority_img']+'" alt="User Image"></a><a href="project-details">'+row['priority_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
				return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="company-details" class="avatar avatar-rounded border me-2"><img class="w-auto h-auto" src="'+row['recent_img']+'" alt="User Image"></a><a href="company-details">'+row['recent_name']+'</a></h6>';
			}},
			{ "render": function ( data, type, row ){
