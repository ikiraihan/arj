    ...
    if($('#payments-list').length > 0) {
        $('#payments-list').DataTable({
            ...
            "columns": [
                ...
                { "render": function ( data, type, row ){
                    return '<h6 class="d-flex align-items-center fs-14 fw-medium"><a href="company-details" class="avatar avatar-sm border rounded-circle me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details">'+row['customer']+'</a></h6>';
                }},  
                { "data": "amount" },                 
                { "data": "due_date" },                 
                { "data": "payment_method" },                 
