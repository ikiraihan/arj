    ...
    if($('#project-list').length > 0) {
		$('#project-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 fw-medium"><a href="project-details" class="avatar border rounded-circle me-2"><img class="w-auto h-auto" src="'+row['pro_img']+'" alt="User Image"></a><a href="project-details">'+row['name']+'</a></h6>';
				}},
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 fw-medium"><a href="company-details" class="avatar avatar-sm border rounded-circle me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details">'+row['client']+'</a></h6>';
				}},   
				{ "render": function ( data, type, row ){
