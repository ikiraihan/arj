    ...
    if($('#proposals-list').length > 0) {
		$('#proposals-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fw-medium fs-14"><a href="company-details" class="avatar avatar-sm border rounded-circle me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details">'+row['sent_to']+'</a></h6>';
				}},
				{ "data": "total_value" },  
				{ "render": function ( data, type, row ){
