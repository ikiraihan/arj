    ...
    if($('#leads_list').length > 0) {
		$('#leads_list').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="leads-details" class="avatar me-2"><img class="img-fluid rounded-circle" src="' + row['customer_image'] + '" alt="User Image"></a><a href="leads-details" class="d-flex flex-column">' + row['customer_name']  + ' </span></a></h6>';
					}
				},
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="company-details" class="avatar border rounded p-1 me-2 rounded-circle"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column">'+row['company_name']+'<span class="text-body fs-13 mt-1 fw-normal">'+row['company_address']+' </span></a></h6>';
				}},
				{ "data": "phone" },
				{ "render": function ( data, type, row ){
