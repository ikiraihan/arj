    ...
    if($('#companieslist').length > 0) {
		$('#companieslist').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="company-details" class="avatar avatar-sm border rounded-circle p-1 me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column fw-medium">'+row['company_name']+'</a></h6>';
				}},
				{ "data": "email" },
				{ "render": function (data, type, row) {
