    ...
    if($('#company_reports').length > 0) {
		$('#company_reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h6 class="d-flex align-items-center fs-14 fw-medium mb-0"><a href="company-details" class="avatar rounded-circle border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details">'+row['company_name']+'</a></h6>';
				}},
				{ "data": "email" },
				{
					"render": function (data, type, row) {
